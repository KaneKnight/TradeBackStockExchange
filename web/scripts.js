...
var canvCont = document.getElementById('graph_display_canvas');
const outerWidth = canvCont.offsetWidth;
const outerHeight = canvCont.offsetHeight;
const width = outerWidth - margin.left - margin.right;
const height = outerHeight - margin.top - margin.bottom;

const container = d3.select('#graph_display_canvas');
